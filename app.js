...
// 交互状态
let isDrawing = false;
let isGrabbing = false; // 左手是否正在搬运面板
let lastDrawUV = null;
...
function getPinchInfo(hand) {
    ...
    return {
        ...
        pos: BABYLON.Vector3.Center(t, i)
    };
}
